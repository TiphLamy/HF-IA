...
J. BallÃƒÆ’Ã‚Â©, V. Laparra, E.P. Simoncelli (2017):
  ...
  with tf.Session() as sess:
    ...
    if args.verbose:
      ...
      with open("Metrics","a") as f:
        metrics = "File: {}\nMean squared error: {:0.4f}\nPSNR (db): {:0.2f}\nMultiscale SSIM: {:0.4f}\nMultiscale SSIM (dB): {:0.2f}\nInformation content in bpp: {:0.4f}\nActual bits per pixel: {:0.4f}\n\n"
        f.write(metrics.format(filename[-1],mse,psnr,msssim,-10 * np.log10(1 - msssim),eval_bpp,bpp))
